<?php
    $isRequiredVariableExists = function_exists("post") && function_exists("getFileLocation") && isset($user_data) && isset($items) && isset($today);
