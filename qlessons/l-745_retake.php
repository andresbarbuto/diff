...
$page_html_title = "Quinceañera Lesson 1: Living a Holy Life";
include '../start.php';
?>
...
<div class="static pt-1 pb-2" id="top">  
    ...
    if (!empty($_SESSION['username'])) { //Check if user is logged in
        ...
        ?>
        <h1 class="static-title">Lesson <?php echo $lesson_id ?> Quiz Retake Assigned</h1>
        <p><?php
                ...
                if ($lupdate) {
                    ...
                    if ($row_quiz_info = $quiz_info->fetch_row()) {
                        ...
                        mysqli()->query("INSERT IGNORE INTO reading_timed (user_id, lesson_id, created_at, reading_time) 
                            VALUES ('$id', '$lesson_id', '$now', '00:00:00') ") or die(mysqli()->error);
                    }
