...
$add_doc_flag = getQls()->SQL->query ("UPDATE quiz_results SET doc_flag= $doc_flag WHERE lesson_id='$lesson_id' AND user_id='$id' ORDER BY created_at DESC LIMIT 1 ") or die(getQls()->SQL->error());
