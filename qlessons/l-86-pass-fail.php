<?php
// test for Abortion Cert Course not passed.. alert on screen
...
?>
<input type="button" value="Reset this Lesson" class="btn btn-success  mb-2" onClick="window.location='qlessons/l-86_retake.php' "/> 
<?php echo " </span></p>";
	} else {
