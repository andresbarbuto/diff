...
$page_html_title = "Pre Cana Preparation Quiz Retake Assigned";
include '../start.php';
?>
...
<div class="static pt-1 pb-2" id="top">  
    ...
    if (!empty($_SESSION['username'])) { //Check if user is logged in
        ...
        <p><?php
            $retake_max = mysqli()->query("SELECT * FROM quiz_retakes WHERE lesson_id = 234 AND user_id = '$id' and created_at > DATE_SUB(NOW(), INTERVAL 2 WEEK)")->num_rows;
