...
if ($lesson_id == 85 && $avg >= 99) {
    ...
    if ($pDate != '' && strtotime($pDate) > strtotime($baptismPassFailPhp_lastQuiz)) {
        ...
        <a href='reading.php?lesson_id=85&page_id=1' class='btn btn-success mt-2 mb-3'><big>Begin the Lesson</big></a></h5>";
    } else {
        ...
        if ($tag == 1) {
            ...
            echo "<h5>You are requesting a certificate against a previously used course. Please purchase the lesson again in order to continue with your certificate request. <br/><a href='/shop/lessons_detail.php?id=85' class='btn btn-success mt-2 mb-3' > <big>Purchase New Baptism Lesson</big> </a></h5><br/>";
        }
    }
}
